namespace Model 
{
  public class Rota 
  {
    ...
    {
      return $"Id: {this.Id} Caminhão: {this.Caminhao} Partida: {this.Partida} Chegada: {this.Chegada} Data: {this.Data}";
    }

    public static void EditarRota(int id, Caminhao caminhao, Cidade partida, Cidade chegada, string data)
    {
    ...
    public static List<string> ListarRotas()
    {
      ...
      {
        stringRotas.Add($"Id: {rota.Id} Caminhão: {rota.Caminhao} Partida: {rota.Partida} Chegada: {rota.Chegada} Data: {rota.Data}");
      }
